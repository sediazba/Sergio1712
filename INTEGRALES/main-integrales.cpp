...
int main(int argc, char** argv)
{
    ...
    for(int ii = 0; ii < 8; ii = ii + 1){
        ...
        std::cout << (1 - (trapezoid(a, b, N, function)/valor_real)) << "\t" << (1 - (simpson(a, b, N, function)/valor_real)) << "\t" << 
                (1 - (richardson(a, b, N, trapezoid, function, 2)/valor_real)) << "\t" << (1 - (richardson(a, b, N, simpson, function, 4)/valor_real)) << "\n";
    }
